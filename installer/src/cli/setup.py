...
OUTPUT_DIR = os.path.abspath(os.path.join(SETUP_DIR, "..", "..", "..", "output", "middleware"))
...
include_files_path = os.path.join(SETUP_DIR, "..", "..", "..", "resources") # Assuming resources is at the root of the installer dir
...
setup(
    ...
    version="3.0",
    description="Middleware do Velide para realizar integrações com ERPs e sistemas locais.",
    executables=[main],
    options={
        "build_exe": {
            "packages": [
