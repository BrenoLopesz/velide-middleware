...
class AppPresenter(QObject):
    ...
    def __init__(
        ...
        self._dashboard_presenter = DashboardPresenter(self._view, self._services, self._machine)
        self._deliverymen_mapping_presenter = DeliverymenMappingPresenter(self._view, self._services, self._machine)
    ...
    def _connect_actions(self):
        ...
        self._machine.logged_out_state.entered.connect(lambda: self._view.show_screen_by_index(0))
        self._machine.logged_out_state.device_flow_state.entered.connect(lambda: self._view.show_screen_by_index(1))
        self._machine.logged_in_state.dashboard_state.entered.connect(lambda: self._view.show_screen_by_index(3))
        self._machine.logged_in_state.deliverymen_mapping_workflow.entered.connect(lambda: self._view.show_screen_by_index(4))
