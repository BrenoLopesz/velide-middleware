...
class VelideWebsocketsService(QObject):
    ...
    def start_service(self):
        ...
        if self.access_token is None:
            self.logger.error("Não foi possível conectar com o Velide: Não está autenticado ainda.")
            return
    ...
    def stop_service(self):
        ...
        if self._worker:
            ...
            self._worker.stop()
            # FSM will transition to Offline via _on_worker_finished or _on_worker_status_changed
