...
class Order(BaseModel):
    ...
    created_at: datetime = Field(
        ..., alias="createdAt", description="Time of sale creation."
    )

    # Optional fields
    customer_contact: Optional[str] = Field(
        None, alias="customerContact", description="Customer contact information."
    )
    ...
    internal_id: str = Field(
        ..., description="Internal ERP ID used for tracking.", exclude=True
    )
...
class GraphQLResponse(BaseModel):
    ...
    data: Optional[
        Union[
            AddDeliveryData, GetDeliverymenData, DeleteDeliveryData, GlobalSnapshotData
        ]
    ] = None
...
class GraphQLRequestError(GraphQLError):
    ...
    def __init__(self, status_code: int, response_text: str):
        ...
        super().__init__(
            f"GraphQL mutation failed with status code {status_code}: {response_text}"
        )
...
class GraphQLParseError(GraphQLError):
    ...
    def __init__(self, response: httpx.Response):
        ...
        super().__init__(
            f"Could not parse response as JSON. Status: {response.status_code}"
        )
